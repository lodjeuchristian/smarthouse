 ...
 * JAnimatedIcon : <br>
 *<br>
 * Permet de créér des JLabel animé!!<br>
 * La classe utilise son propre format d'animation (fichiers en .ai) : pour creer une animation, utiliser saveAnimatedIcon() qui
 * a partir d'une grosse image decoupe les images de l'animations (images de l'animation toutes de la meme taille et placées 
...
public class JAnimatedIcon extends  JLabel
{
     ...
     * Animation chargee a partir d'un gif animé !!
    ...
    public JAnimatedIcon(String gif,int milli)
    {
     ...
     /** 
     * constructeur
      *<br>Copie de l'icone passé en parametre
    ...
    /** 
     * constructeur
      *<br>Copie de l'icone passé en parametre avec transparence
     @param a le JAnimatedIcon a copier
    ...
    /**
     * créé le thread gérant les anims
     */
    ...
    private void    nextFrame()
    {
        ...
        if  (duration>0)
        {
            if  (debut>0)
            {
                if  ( (((int) System.currentTimeMillis())-debut) >= duration)   //duree depassée
                {
                    setPause(true);
                    c_img=-1;
                    debut=-1;
    ...
    /**
     * appellé a la destruction de la classe
     *<br>
     *EXPERIMENTAL
     */
    protected   void    finalize() throws Throwable
    {
     ...
     /**
     * sauvegarde d'une image en format approprié pour un animated icon (JAnimatedIcon)
     *<br>les images de l'animation doivent etre alignées horizontalement et doivent faire la meme taille
    ...
    public  static  boolean saveAnimatedIcon(BufferedImage img,String dest,int wi,int hi,int milli)
    {
     ...
     /**
     * charge une image en format approprié pour un animated icon (JAnimatedIcon) (sauvegardé avec saveAnimatedIcon)
     @param src le fichier animated icon créé avec saveAnimatedIcon
     @param key la couleur transparente
     @param tolerance la tolerance sur la couleur transparente (comprise entre 0 et 1)
     @return le JAnimatedIcon chargé ou null si erreur
     */
     ...
     * les pixels de cette couleur ne seront pas affichés lors de drawImage 
